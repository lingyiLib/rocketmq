...
use lingyiLib\rocketmq\consumer\rebalance\AllocateMessageQueueAveragely;
use lingyiLib\rocketmq\consumer\store\LocalFileOffsetStore;
use lingyiLib\rocketmq\consumer\store\OffsetStore;
use lingyiLib\rocketmq\consumer\store\ReadOffsetType;
use lingyiLib\rocketmq\consumer\store\RemoteBrokerOffsetStore;
...
use lingyiLib\rocketmq\remoting\heartbeat\ConsumeType;
...
use lingyiLib\rocketmq\util\FilterApi;
...
class DefaultMQConsumer implements MQConsumerInner
{
     ...
     */
    private $postSubscriptionWhenPull = true;
